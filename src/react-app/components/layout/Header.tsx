...
function Header() {
  ...
  const navLinks = [
    { label: "Start Here", href: "#start", dropdown: true },
    { label: "Spring Courses", href: "#spring", dropdown: true },
    { label: "Java Courses", href: "#java", dropdown: true },
    { label: "Pricing", href: "#pricing", dropdown: false, highlight: true },
        ...
        <div className="flex h-14 items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <a href="/" className="flex items-center space-x-2 font-serif text-xl font-bold tracking-tight">
              ...
              <span className="tracking-wide">baeldung</span>
            </a>
          </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            >
              <svg className="h-5 w-5 text-[#f5c147]" fill="currentColor" viewBox="0 0 24 24">
                <path d="M2 4l3 7 7-9 7 9 3-7v13H2V4zm0 15h20v2H2v-2z" />
              </svg>
            </a>
